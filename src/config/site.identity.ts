export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'galaxysblog',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Galaxysblog',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'galaxysblog.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://galaxysblog.com',
